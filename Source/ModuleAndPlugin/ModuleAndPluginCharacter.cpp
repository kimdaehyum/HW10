...
#include "ChData/CharacterData.h"
...
void AModuleAndPluginCharacter::BeginPlay()
{
	...
	if (TestActor)
	{
		 GetWorld()->SpawnActor<ATestActor>(TestActor, FVector::ZeroVector, FRotator::ZeroRotator);
	}
	PrintCharacterInfo();
}

void AModuleAndPluginCharacter::PrintCharacterInfo()
{
	UCharacterData* CharacterData = NewObject<UCharacterData>(this);
	UE_LOG(LogTemp, Display, TEXT("CharacterName: %s"), *(CharacterData->CharacterName));
	UE_LOG(LogTemp, Display, TEXT("MaxHP: %d"), CharacterData->MaxHP);
	UE_LOG(LogTemp, Display, TEXT("CurrentHP: %d"), CharacterData->CurrentHP);
	UE_LOG(LogTemp, Display, TEXT("MaxSpeed: %f"), CharacterData->MaxSpeed);
	UE_LOG(LogTemp, Display, TEXT("CurrentSpeed: %f"), CharacterData->CurrentSpeed);
}
//////////////////////////////////////////////////////////////////////////
// Input
